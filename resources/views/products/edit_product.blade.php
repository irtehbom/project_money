...
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="POST" id="form-validate" name="form-validate" action="{{ url('products/edit_product/') }}/{{ $product->id }}">
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    ...
                    Product Title
                    <div class="spacer">
                        <input type="text" class="form-control spacer" name="title" id="title" placeholder="Product Title" value="{{$product->title}}">
                    </div>
                    Product Description
                    <div class="spacer">
                        <textarea type="text" class="form-control spacer" name="content" id="content" placeholder="Product Content">{{$product->content}}</textarea>
                    </div>
                    ...
                    @if($loop->first)
                         ...
                         <div class="input-group control-group after-add-more">
                            <input type="text" name="key_features[]" class="form-control" placeholder="Enter Product Feature Here" value="{{$features}}">
                ...
                <div id="menu1" class="tab-pane fade">
                    ...
                    Product Rating
                    <div class="spacer">
                        <input type="text" class="form-control spacer" name="rating" id="rating" placeholder="Product Rating - Enter 0 - 5" value="{{$product->rating}}">
                    </div>
                </div>
                ...
                <div id="images" class="tab-pane fade">
                    ...
                    Product ASIN
                    <div class="spacer">
                        <input type="text" class="form-control spacer" name="asin" id="asin" placeholder="Enter ASIN product code" value="{{$product->asin}}">
                    </div>

                    <div id="load_amazon_data" class="btn btn-warning btn btn-sm">Load Fresh Amazon Data</div>
                    ...
                    <div class="hide_amazon_data spacer" style="border-top:1px solid #ccc">
                        ...
                        <select class="image-picker show-html" id="multiple-select-picker" data-limit="5" multiple="multiple">

                            @foreach ($product->selected_image_array as $product_url)
                            <option data-img-src="{{$product_url}}">{{$product_url}}</option>
                            @endforeach
                        ...
                        <h4>Select a featured image</h4>
                        Select a featured image from your selected images.
                        <div class="spacer"></div>

                        <select class="image-picker-featured show-html" id="featured-select-picker" data-limit="1" >
                            <option data-img-src="{{$product->featured_image}}">{{$product->featured_image}}</option>
                        </select>
                    </div>
            ...
            <input type="hidden" class="hidden" name="featured_image" id="featured_image" value="{{$product->featured_image}}">
