...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Add Guide
            </li>
        </ol>
    </div>
</div>
...
<form method="POST" id="form-validate" name="form-validate" action="{{ url('buying_guides/add') }}">
    ...
    <div class="spacer">
        <div class="input-group">
            ...
            <input class="form-control inline" name="slug" id="slug" value="" placeholder="SEO Url" type="text"/>
        </div>
    </div>
        ...
        <div id="content" class="tab-pane fade in active">
            ...
            <div class="spacer">
                <div class="input-group">
                    ...
                    <input class="form-control inline" name="title" id="title" placeholder="Page Title" type="text" value=""/>
                </div>
            </div>

            Page Content
            <div class="spacer">
                <textarea type="text" class="form-control spacer mceEditor" name="content" id="content" placeholder="Product Content" value=""></textarea>
            </div>
        ...
        <div id="seo" class="tab-pane fade in">
            ...
            <div class="spacer">
                <div class="input-group">
                    ...
                    <input class="form-control inline" name="meta_title" id="meta_title" placeholder="Meta Title" type="text" value=""/>
            ...
            <div class="spacer">
                <div class="input-group">
                    ...
                    <input class="form-control inline" name="meta_description" id="meta_description" placeholder="Meta Description" type="text" value=""/>
                </div>
            </div>
...
<input name="products_order" id="products_order" type="hidden" value=""/>
<input name="all_order" id="all_order" type="hidden" value=""/>
<input name="product_list" id="productlist" type="hidden" value=""/>
<input name="category" id="category_input" type="hidden" value=""/>
